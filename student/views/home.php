...
<div class="card-footer" style="padding-top:4px;padding-bottom:4px;display:flex;justify-content:center;width:100%;">
  <a href="myDetails.php"  style="margin:0;padding:0;">
  <input type="button" class="btn" value="My Details" style="padding-left:10px;padding-right:10px;font-size:20px;"></input></a>
</div>
...
<div class="card-footer" style="padding-top:4px;padding-bottom:4px;display:flex;justify-content:center;width:100%;">
    <a href="view_marks.php"  style="margin:0;padding:0;">
    <input type="button" class="btn" value="View Marks" style="padding-left:10px;padding-right:10px;font-size:20px;"></input></a>
...
<div class="card-footer" style="padding-top:4px;padding-bottom:4px;display:flex;justify-content:center;width:100%;">
<a href="view_students.php"  style="margin:0;padding:0;">
<input type="button" class="btn" value="Edit Details" style="padding-left:10px;padding-right:10px;font-size:20px;"></input></a>
</div>
</div>
